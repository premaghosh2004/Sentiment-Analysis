...
set CONDAPATH=Users/Sagnik0684/Desktop/GeminiChatbot/Anaconda3
...
streamlit run "scripts//GeminiChatbot.py" --theme.base="dark" --theme.primaryColor="#7AED07" --theme.backgroundColor="#000001" --theme.secondaryBackgroundColor="#0000B3" --theme.textColor="#FFFFFF" --theme.font="sans serif"
